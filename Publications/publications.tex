...
\end{journals}
\begin{conferences}
\item \textbf{Y Wang}*,  Q. Qiao*, X. Fan, and P. Lu, "Lasso Gripper: A String Shooting-Retracting Mechanism for Shape-Adaptive Grasping",  \textit{IEEE International Conference on Robotics and Biomimetics (ROBIO)}. (Accepted; Conference in December 2025) 2025. 
\end{conferences}
% \newpage
% ---------------------------------------------------------------------------
%  CONFERENCES
