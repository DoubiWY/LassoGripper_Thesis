...
This thesis adopts a mechanism-centered perspective to address these issues. The central question is how tendon-driven mechanisms can be designed to deliver adaptive, dexterous, and reliable manipulation while meeting constraints on size, weight, and compliance. To answer this,  a transferable tendon-driven design framework is developed and validated with two embodiments: Lasso Gripper (an adaptive loop-based end-effector) and a handheld motorized laparoscopic instrument.
...
Within this thesis, Lasso Gripper serves as the first mechanism instantiation and as the main source of transferable design insights. Its development makes it possible to study several mechanism-level questions: how tension can be maintained during reversible actuation, how launch-and-retraction dynamics affect capture range, how a flexible loop can improve robustness to object uncertainty, and how remote actuation can be coordinated to preserve low distal complexity. These insights are treated not as properties of a single prototype, but as candidate design rules for tendon-driven systems more broadly.
...
\begin{enumerate}
    ...
    \item The extraction of transferable design principles from Lasso Gripper and their translation into a handheld motorized laparoscopic instrument for minimally invasive manipulation.
...
The remainder of this thesis is organized to follow that mechanism-centered narrative. Chapter 2 reviews related work in laparoscopic end-effectors and adaptive grasping systems, with emphasis on actuation, sensing, and tendon-driven design trade-offs. The subsequent chapters present Lasso Gripper, including its mechanism design, grasping strategy, dynamic behavior, and experimental validation. The thesis then transitions to the handheld surgical instrument, where the previously derived tendon-driven principles are translated into a compact device architecture, cable routing design, sensing strategy, and control framework. The final chapters discuss the broader implications of these results and outline future directions for tendon-driven robotic mechanisms.
