...
This chapter summarizes the main contributions of the thesis: a mechanism-level study of tendon-driven systems, the design and qualitative demonstration of Lasso Gripper as a feasibility platform, and the translation of derived design rules into a handheld laparoscopic instrument. The chapter highlights key findings, acknowledges limitations, and outlines directions for future work.
...
A comprehensive experimental framework validates both applications, confirming the effectiveness of the surgical instrument in enhancing surgical dexterity and Lasso Gripper's proficiency in grasping both static and dynamic objects. These parallel developments highlight the cross-domain potential of tendon-driven systems.
