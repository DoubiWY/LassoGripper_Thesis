...
\noindent
This chapter details component-level design choices and their rationale: motor and sensor selection, tip guidance and cable routing, paired-cable reel mechanisms, and the quick-swap end-effector interface. Emphasis is placed on preserving cable tension, minimizing hysteresis, and enabling modularity suitable for handheld laparoscopic tools.

\noindent
Key specifications and trade-offs are given to motivate selections; thorough mechanical verification and long-term durability testing are left for future work.
