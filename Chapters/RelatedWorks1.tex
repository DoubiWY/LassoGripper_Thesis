...
\noindent
This chapter surveys prior work relevant to tendon-driven and laparoscopic end-effectors, including actuation technologies, sensing strategies, tip and rod architectures, soft and continuum approaches, and AI-assisted monitoring and control. It highlights recurring challenges such as cable coupling, material creep and stretch, frictional losses, and the trade-offs between flexibility and load capacity.

\noindent
The chapter identifies open gaps that motivate this thesis: compact, tension-preserving cable routing; miniature sensing for closed-loop compensation; and mechanism-level evaluations that connect design choices to practical performance.
