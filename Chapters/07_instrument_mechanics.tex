...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        ...
        \label{fig:82}
    \end{subfigure}
    \caption{Feetech Servo: left motor for output (STS3032), right motor for wrist inputs (STS3009)}
\end{figure}
